...
class Config:
    ...
    def __init__(self):
        ...
        self.num_epochs = 23  #训练次数，50轮收敛
        self.batch_size = 8  #mini_batch大小
...
class CodeBert_Blstm(nn.Module):
    ...
    def forward(self, s, x1, x2):
        ...
        sq_out = codebert_out[0]
        atten_score = codebert_out[2]  # (layer_num, batch_size, num_heads, sequence_length, sequence_length)
        atten_score = [a_score.cpu().detach().numpy() for a_score in atten_score]
        pkl.dump(atten_score, open('atten_score_example.pkl', 'wb'))
        ...
        # sf_atten_out1, sf_score = self.sf_attention(out1)
